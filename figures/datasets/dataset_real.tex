...
\definecolor{cA}{HTML}{6E0B20}
\definecolor{cB}{HTML}{A81734}
\definecolor{cC}{HTML}{D43A58}
\definecolor{cD}{HTML}{E8697F}
\definecolor{cE}{HTML}{F29BAC}
\definecolor{cF}{HTML}{FAC9D3}
\definecolor{lblcol}{HTML}{D9224C}
...
\begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
  ...
  \node[anchor=north east,lblcol] at (8.6,2.78)
    {\fontsize{34}{34}\selectfont $\mathcal{D}_{\mathrm{real}}$};
